...
```bash
# 1. 解压 bundle
tar --zstd -xf opencode-onprem-v1.18.30-linux-x64.tar.zst
cd opencode-onprem-v1.18.30-linux-x64/
...
git apply ../opencode-onprem-bundle/patches/004-eslint-onprem.patch
